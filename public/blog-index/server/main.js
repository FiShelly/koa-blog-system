...
var ArticleDetailComponent = /** @class */ (function () {
    function ArticleDetailComponent(transferState, eventBus, storageService, 
    // private commentService: CommentService,
    articleService, router, route) {
        this.transferState = transferState;
        this.eventBus = eventBus;
        this.storageService = storageService;
    ...
    ArticleDetailComponent.prototype.getArticleAndComment = function () {
        var _this = this;
        var allHttp = rxjs_1.forkJoin(this.articleService.getPost(this.article.id)
        // 2019-12-27 注释
        // ,
...
var UnifyResquestInterceptor = /** @class */ (function () {
    function UnifyResquestInterceptor(router, storage, ctx) {
        this.router = router;
        ...
        if (!EXCLUDED_METHOD.includes(req.method.toUpperCase())) {
            var header = {
                headers: new http_1.HttpHeaders({
                    'x-csrf-token': (this.ctx && this.ctx.csrf) || window._CSRF
                })
            };
...
var TypetagService = /** @class */ (function (_super) {
    ...
    TypetagService.ngInjectableDef = i0.defineInjectable({ factory: function TypetagService_Factory() { return new TypetagService(i0.inject(i1.HttpClient), i0.inject("koaCtx", 8)); }, token: TypetagService, providedIn: "root" });
...
var UserService = /** @class */ (function (_super) {
    ...
    UserService.ngInjectableDef = i0.defineInjectable({ factory: function UserService_Factory() { return new UserService(i0.inject(i1.HttpClient), i0.inject("koaCtx", 8)); }, token: UserService, providedIn: "root" });
    return UserService;
}(common_service_1.CommonService));
